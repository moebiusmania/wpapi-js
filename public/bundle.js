...
/***/ function(module, exports, __webpack_require__) {
	...
	// Global objects
	var myWP = new _wporgclass2.default();
	
	// Load and render categories
	myWP.getCategories().then(function (data) {
	  var cats = (0, _utils.$)('#select-cat');
	  data.length ? cats.disabled = false : null;
	  (0, _utils.renderCats)(data, (0, _utils.$)('#categories').innerHTML, cats);
	});
	
	// Load and render posts
	(0, _utils.$)('#posts').addEventListener('click', function (evt) {
	  (0, _utils.$)('#spinner').style.display = 'block';
	  (0, _utils.$)('#posts-output').innerHTML = '';
	
	  var opts = {
	    number: parseInt((0, _utils.$)('input[type="number"]').value),
	    cat: parseInt((0, _utils.$)('#select-cat').value)
	  };
	
	  myWP.getPosts(opts).then(function (data) {
	    console.log(data);
	    (0, _utils.$)('#spinner').style.display = 'none';
	    (0, _utils.renderPosts)(data, (0, _utils.$)('#post').innerHTML, (0, _utils.$)('#posts-output'));
	  });
	});
